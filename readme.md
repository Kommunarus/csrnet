...
Был собран датасет из 60 изображений и размечен центральными точками балок:

![Пример датасета 1](pic_ds/pic1.png)
![Пример датасета 2](pic_ds/pic2.png)
![Пример датасета 3](pic_ds/pic3.png)

Результатом стал небольшой датасет с точечными аннотациями:

![Размеченный датасет](pic_ds/pic4.png)
...
![Тестовый результат 0](pic_test/test_0.png)
![Тестовый результат 1](pic_test/test_1.png)
![Тестовый результат 2](pic_test/test_2.png)
![Тестовый результат 3](pic_test/test_3.png)
![Тестовый результат 4](pic_test/test_4.png)
![Тестовый результат 5](pic_test/test_5.png)
